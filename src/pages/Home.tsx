  ...
  async function loadGalleryPreview() {
    ...
    const albumsWithSignedCover = await Promise.all(
      (data || []).map(async (album) => ({
        ...album,
        signed_cover_url: await getSignedUrlFromPublicUrl(
    ...
    <main style={styles.page}>
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.heroTitle}>Karate per bambini, ragazzi e adulti</h1>

          <p style={styles.heroSubtitle}>
            Disciplina, rispetto e crescita attraverso il Karate Shotokan. Non
            solo sport. Un percorso di vita.
          </p>
        ...
        <div style={styles.aboutCard}>
          <div style={styles.aboutTextBox}>
            ...
            <h2 style={styles.sectionTitle}>
              Una scuola di Karate, prima di tutto educativa
            </h2>

            <p style={styles.text}>
              Il Dojo Yamato nasce con l’obiettivo di trasmettere il Karate
              Shotokan come disciplina marziale, sportiva ed educativa. Ogni
              allenamento è un percorso fatto di rispetto, impegno,
              autocontrollo e crescita personale.
            </p>
      ...
      <section style={styles.section}>
        <div style={styles.sectionHeader}>
          ...
          <p style={styles.sectionSubtitle}>
            Corsi dedicati a bambini, ragazzi e adulti, con percorsi adatti al
            livello e all’età degli allievi.
          </p>
        </div>
        ...
        <div style={styles.competitionCard}>
          <div style={styles.competitionTextBox}>
            ...
            <p style={styles.competitionText}>
              La competizione è proposta come esperienza educativa, sempre senza
              obbligo. Aiuta gli allievi a gestire emozioni, concentrazione,
              confronto e rispetto dell’avversario.
            </p>

            <p style={styles.competitionText}>
              Il Dojo Yamato partecipa a competizioni provinciali, regionali e
              nazionali nei circuiti CSI e FIJLKAM, accompagnando ogni atleta
              nel proprio percorso con gradualità e attenzione.
            </p>
        ...
        <div style={styles.defensePromoCard}>
          <div>
            ...
            <p style={styles.defensePromoText}>
              ...
              a ragazze, donne e a chiunque desideri sentirsi più sicuro nella
              vita quotidiana.
            </p>
      ...
      <section style={styles.section}>
        <div style={styles.sectionHeader}>
          ...
          <p style={styles.sectionSubtitle}>
            Alcuni momenti di allenamento, eventi, esami e attività del nostro
            dojo.
          </p>
        </div>
      ...
      <section style={styles.cta}>
        ...
        <p style={styles.ctaText}>
          Contattaci per informazioni sui corsi, gli orari e le sedi del Dojo
          Yamato.
        </p>
