  ...
  async function handleSignup(e: FormEvent | MouseEvent<HTMLButtonElement>) {
    ...
    if (data.user) {
      ...
      if (!approvalResponse.ok) {
        setMessage(approvalResult?.error || 'Registrazione creata, ma non ̬ stato possibile inviare la richiesta di approvazione.')
        return
      }
    ...
    setMessage('Registrazione inviata. Il tuo account ̬ in attesa di approvazione da parte della segreteria.')
  }
